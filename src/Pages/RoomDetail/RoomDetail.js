...
class RoomDetail extends Component {
  ...
  handleClick = e => {
    ...
    if (token) {
      console.log("before: " + this.state.house.bookmark);
      ...
      console.log("after: " + this.state.house.bookmark);
  ...
  componentDidMount = () => {
    fetch("http://3.35.140.224:9000/homes/8")
              ...
              <div className="titleBox">
                ...
                <div className="headerIconLine">
                  <div className="headerShereIconBox">
                    <button className="headerIconBtnShare" onClick={() => this.handleModal("shareModal")} type="button">
                      ...
                      {this.state.shareModal ? (
                        ...
                        >
                          {shareLinks.map((shareLink, index) => {
                            return <ShareList iconImg={shareLink.iconImg} iconText={shareLink.iconText} key={index} />;
                          })}
                        </PopUp>
                      ) : (
                        ""
